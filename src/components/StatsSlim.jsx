...
const StatsSlim = ({ player }) => {
  ...
  if (player.position === 'G') {
    stats = [player.stats.featuredStats.playoffs.subSeason.wins, 'W', player.stats.featuredStats.playoffs.subSeason.shutouts, 'SO', player.stats.featuredStats.playoffs.subSeason.otl, 'OTL'];
