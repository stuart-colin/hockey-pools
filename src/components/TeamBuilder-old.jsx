...
import { Button, Dropdown, Grid, Icon, Menu, Segment, Table } from "semantic-ui-react";
      ...
      return (
        <Table.Row>
          <Table.Cell>
            <Button
              icon
              disabled={counts[roster.positionCode] >= rosterLimits[roster.positionCode] + limitBonus
              ...
              onClick={() => setMyTeam(
                JSON.stringify(myTeam).includes(JSON.stringify([team[0], team[1], roster]))
                  ...
                  : counts[roster.positionCode] >= rosterLimits[roster.positionCode] + limitBonus ? myTeam
